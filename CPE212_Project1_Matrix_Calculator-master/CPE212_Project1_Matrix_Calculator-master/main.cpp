//
// main.cpp --  Project01, CPE212 Spring 2018 -- C++ Review Project
//
...
int main (int argc, char * const argv[])      // Command-line arguments (more on this later)
{
  ...
  LoadImage(inputs, image);       // Implement this function in project01.cpp
  // LoadImage must read the image data from the previously opened file stream and place
  // the data into the image array
